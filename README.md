...
Bağlantı `Todolist2/Todolist2/appsettings.json` içindeki `ConnectionStrings:DefaultConnection` alanından okunur. Depodaki varsayılan değer Windows kimlik doğrulamalı LocalDB içindir ve parola içermez. Kendi SQL Server ortamınız için bu değeri User Secrets veya ortam değişkeniyle geçersiz kılın:
